    ...
    return (
        <div className='flex gap-4 flex-row justify-center md:flex-col p-4'>
            ...
            <div className='flex flex-col justify-center md:justify-start'>
                <div className='text-3xl text-gray-800 dark:text-gray-400 font-semibold font-mono'>{name ? name : login}</div>
                {name && <div className='text-gray-500 dark:text-gray-600 font-semibold font-mono'>{login}</div>}
            </div>
        </div>
    )
}
