  ...
  return (
    <div className='flex justify-center py-40'>
      <div className='max-w-2xl text-center'>
        <p className="text-3xl text-amber-500 dark:text-amber-500 mb-5">
          Page Not Found!</p>
        <div onClick={() => navigate("/")} className="cursor-pointer inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
          Go Back Home
